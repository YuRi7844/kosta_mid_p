...
public class EnrollmentDaoImpl implements EnrollmentDao{
	...
	/*@Override
	public int selectEnrollmentStudentBySubjectDay(SqlSession session, Enrollment enrollment) {
		return session.selectOne(makeSqlId("selectEnrollmentStudentBySubjectDay"), enrollment);
	}*/

	@Override
	public int selectEnrollmentStudentBySubjectTime(SqlSession session, Enrollment enrollment) {
		return session.selectOne(makeSqlId("selectEnrollmentStudentBySubjectTime"), enrollment);
	}
	...
	@Override
	public List<Integer> selectEnrollmentByStudentIdInt(SqlSession session, int studentId) {
		return session.selectList(makeSqlId("selectEnrollmentByStudentIdInt"), studentId);
	}
