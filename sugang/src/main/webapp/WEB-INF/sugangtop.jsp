...
<header>
	...
	<div class="top">
		<p
			style="font-size: 30px; padding-left: 20px; margin-top: 10px; margin-bottom: 10px; text-align: center;">
			<strong>수강신청</strong>
		</p>
		<p
			style="margin-top: 5px; margin-bottom: 7px; text-align: right; padding-right: 50px">
			<strong>
			아이디: <input type="text" name="studentId" size="10" value="&nbsp;${sessionScope.loginStudent.studentId }" readonly style="border: 0px; background-color: #e2e2e2; padding:2px 0px 2px 30px;">
			이름 : <input type="text" name="studentName" size="10" value="&nbsp;&nbsp;&nbsp;${sessionScope.loginStudent.studentName }" readonly style="border: 0px; background-color: #e2e2e2; padding:2px 0px 2px 30px;">
			전공 : <input type="text" name="major" size="10" value="&nbsp;${sessionScope.loginStudent.major }" readonly style="border: 0px; background-color: #e2e2e2; padding:2px 0px 2px 30px;">

			<a class="logoutlink" href="/sugang/logout" style="padding-bottom: 3.5px; padding-top: 3.5px">로그아웃</a> 
		</p>
	</div>
