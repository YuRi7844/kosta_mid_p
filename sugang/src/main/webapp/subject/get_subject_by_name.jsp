				...
				<c:choose>
					<c:when test="${!empty requestScope.subName }">
						...
						%>
							<tr>
								<td class="td">
									<%=subName.get(i).getSubjectId() %>
								</td>		
								<td class="td">
									<%=subName.get(i).getSubjectName() %>
								</td>
								<td class="td">
									<%=subName.get(i).getSubjectCredit() %>
								</td>
								<td class="td">
									<%=subName.get(i).getCompletion() %>
								</td>
								<td class="td">
									<%=subName.get(i).getMaxStudent() %>
								</td>
								<td class="td">
									<%=subName.get(i).getDay() %>
								</td>
								<td class="td">
									<%=subName.get(i).getSubjectTime() %>
								</td>
								<td >
									<input type="hidden" name="addSubjectId" value="<%=subName.get(i).getSubjectId() %>">
