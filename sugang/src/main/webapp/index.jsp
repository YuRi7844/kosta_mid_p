...
<body>
	...
	<c:if test="${sessionScope.loginStudent == null }">
		<section>
			...
			<div style="width: 400px; margin: 0 auto; margin-top: 100px; margin-bottom: 100px;">
				<p style="text-align: center; background-color: lightgrey; font-size: 18px; border-left: 10px solid black; margin-bottom: 2px; height: 40px;">
					수강 신청 로그인</p>
