...
-- 강좌 등록
insert into subject(subject_id,subject_name,subject_credit) values(0001,'자바의정석',3);
insert into subject(subject_id,subject_name,subject_credit) values(0002,'집에',3);
insert into subject(subject_id,subject_name,subject_credit) values(0003,'가고싶다',3);
insert into subject(subject_id,subject_name,subject_credit) values(0004,'이딴거',3);
insert into subject(subject_id,subject_name,subject_credit) values(0005,'졸라',3);
insert into subject(subject_id,subject_name,subject_credit) values(0006,'시러',3);
insert into subject(subject_id,subject_name,subject_credit) values(0007,'아아아아아아',3);
insert into subject(subject_id,subject_name,subject_credit) values(0008,'오라클',3);
insert into subject(subject_id,subject_name,subject_credit) values(0009,'언제까지',3);
insert into subject(subject_id,subject_name,subject_credit) values(0010,'해야하나',3);
